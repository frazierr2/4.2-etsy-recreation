...
This project we used Etsy's API and practiced with JSONP and JSON data. We then created a recreation of one projects page with AJAX calls.
...
which is located [HERE]
   ...
   [HERE]: <https://frazierr2.github.io/4.2-etsy-recreation/>
